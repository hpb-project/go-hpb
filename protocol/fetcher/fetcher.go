...
func (f *Fetcher) loop() {
	...
	for {
		...
		for !f.queue.Empty() {
			...
			log.Info("@@@@@@@@@@@@fetcher->insert-->op.origin")
		...
		case notification := <-f.notify:
			...
			log.Info("#################fetcher->loop->A block was announced")
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		log.Info("@@@@@@@@@@@@fetcher->insert-->f.insertChain(types.Blocks{block})")
