...
import (
	...
	"github.com/hpb-project/go-hpb/contracts/chequebook"
	"github.com/hpb-project/go-hpb/contracts/ens"
	...
	"github.com/hpb-project/go-hpb/swarm/api"
	httpapi "github.com/hpb-project/go-hpb/swarm/api/http"
	"github.com/hpb-project/go-hpb/swarm/fuse"
	"github.com/hpb-project/go-hpb/swarm/network"
	"github.com/hpb-project/go-hpb/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *hpbclient.Client, config *api.Config,
	swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
