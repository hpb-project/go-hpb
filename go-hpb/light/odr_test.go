...
func testChainOdr(t *testing.T, protocol int, fn odrTestFn) {
	...
	blockchain, _ := core.NewBlockChain(sdb, params.TestChainConfig, hpbhash.NewFullFaker(), vm.Config{})
	...
	lightchain, err := NewLightChain(odr, params.TestChainConfig, hpbhash.NewFullFaker())
	if err != nil {
		t.Fatal(err)
	}
