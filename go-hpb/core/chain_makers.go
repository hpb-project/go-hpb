...
func (b *BlockGen) OffsetTime(seconds int64) {
	...
	b.header.Difficulty = hpbhash.CalcDifficulty(b.config, b.header.Time.Uint64(), b.parent.Header())
}
...
func GenerateChain(config *params.ChainConfig, parent *types.Block, db hpbdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	...
	genblock := func(i int, h *types.Header, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		hpbhash.AccumulateRewards(config, statedb, h, b.uncles)
...
func makeHeader(config *params.ChainConfig, parent *types.Block, state *state.StateDB) *types.Header {
	...
	return &types.Header{
		...
		Difficulty: hpbhash.CalcDifficulty(config, time.Uint64(), &types.Header{
...
func newCanonical(n int, full bool) (hpbdb.Database, *BlockChain, error) {
	...
	blockchain, _ := NewBlockChain(db, params.AllProtocolChanges, hpbhash.NewFaker(), vm.Config{})
