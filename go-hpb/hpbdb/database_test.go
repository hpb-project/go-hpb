...
func newTestLDB() (*hpbdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ethdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := hpbdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db hpbdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db hpbdb.Database, t *testing.T) {
	const n = 8
