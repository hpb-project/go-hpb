...
import (
	...
	"github.com/hpb-project/go-hpb/swarm"
	bzzapi "github.com/hpb-project/go-hpb/swarm/api"
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-hpb Authors"
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := hpbclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
...
func registerBzzService(ctx *cli.Context, stack *node.Node) {
	...
	boot := func(ctx *node.ServiceContext) (node.Service, error) {
		...
		if ensapi != "" {
			...
			ensClient = hpbclient.NewClient(client)
