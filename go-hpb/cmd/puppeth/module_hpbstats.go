...
// hpbstatsInfos is returned from an ethstats status check to allow reporting
// various configuration parameters.
type hpbstatsInfos struct {
	host   string
	port   int
	secret string
	config string
...
func (info *hpbstatsInfos) String() string {
...
func checkEthstats(client *sshClient, network string) (*hpbstatsInfos, error) {
