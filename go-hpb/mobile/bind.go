...
import (
	...
	"github.com/hpb-project/go-hpb/accounts/abi"
...
func DeployContract(opts *TransactOpts, abiJSON string, bytecode []byte, client *HpbereumClient, args *Interfaces) (contract *BoundContract, _ error) {
...
func BindContract(address *Address, abiJSON string, client *HpbereumClient) (contract *BoundContract, _ error) {
	parsed, err := abi.JSON(strings.NewReader(abiJSON))
	if err != nil {
		return nil, err
	}
