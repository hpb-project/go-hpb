...
import (
	...
	hpbereum "github.com/hpb-project/go-hpb"
...
type wallet struct {
	...
	deriveChain    hpbereum.ChainStateReader // Blockchain state reader to discover used account with
...
func (w *wallet) SelfDerive(base accounts.DerivationPath, chain hpbereum.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()
