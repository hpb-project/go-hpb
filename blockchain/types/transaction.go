...
func NewMessage(from common.Address, to *common.Address, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte, exdata TxExdata, checkNonce bool) Message {
	return Message{
		from:       from,
		to:         to,
		nonce:      nonce,
