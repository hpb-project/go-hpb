// Copyright 2016 The ghpb Authors
...
// ReleaseOracle is an Hpb contract to store the current and previous
// versions of the ghpb implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Hpb user, either
