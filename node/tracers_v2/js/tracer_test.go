...
func TestTracer(t *testing.T) {
	execTracer := func(code string) ([]byte, string) {
		...
		ret, err := runTrace(tracer, testCtx(), params.MainnetChainConfig)
		if err != nil {
...
func TestHalt(t *testing.T) {
	...
	if _, err = runTrace(tracer, testCtx(), params.MainnetChainConfig); err.Error() != "stahp    in server-side tracer function 'step'" {
...
func TestHaltBetweenSteps(t *testing.T) {
	...
	env := vm.NewEVM(vm.BlockContext{BlockNumber: big.NewInt(1)}, vm.TxContext{GasPrice: big.NewInt(1)}, &dummyStatedb{}, params.MainnetChainConfig, vm.Config{Debug: true, Tracer: tracer})
...
func TestNoStepExec(t *testing.T) {
	execTracer := func(code string) []byte {
		...
		env := vm.NewEVM(vm.BlockContext{BlockNumber: big.NewInt(1)}, vm.TxContext{GasPrice: big.NewInt(100)}, &dummyStatedb{}, params.MainnetChainConfig, vm.Config{Debug: true, Tracer: tracer})
