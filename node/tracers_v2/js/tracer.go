...
import (
	...
	tracers2 "github.com/hpb-project/go-hpb/node/tracers_v2"
	"github.com/hpb-project/go-hpb/node/tracers_v2/js/internal/tracers"
...
func (jst *jsTracer) CaptureStart(env *vm.EVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	...
	intrinsicGas := types.IntrinsicGas(input, jst.ctx["type"] == "CREATE", true)
