...
func (bc *BlockChain) insertChain(chain types.Blocks) (int, []interface{}, []*types.Log, error) {
	...
	log.Info("@@@@@@@@@@@@blockchain-->insertChain ")
	...
	for i, block := range chain {
		...
		if err != nil {
            ...
            log.Info("@@@@@@@@@@@@blockchain-->insertChain-bc.futureBlocks.Add")
		...
		case CanonStatTy:
			...
			log.Info("@@@@@@@@@@@@blockchain->insertChain-->CanonStatTy@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
			...
			log.Info("@@@@@@@@@@@@blockchain->insertChain--ChainEvent{block, block.Hash()")
		...
		case SideStatTy:
			...
			log.Info("@@@@@@@@@@@@blockchain->insertChain-->SideStatTy@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
	...
	if lastCanon != nil && bc.LastBlockHash() == lastCanon.Hash() {
		...
		log.Info("@@@@@@@@@@@@blockchain->insertChain--ChainHeadEvent")
	}
