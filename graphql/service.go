...
func New(stack *node.Node, backend hpbapi.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend hpbapi.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
